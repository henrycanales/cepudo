...
if($_SESSION['session_nivel_cepudo']=="root" || $_SESSION['session_nivel_cepudo']=="EntregasProyecto")
{
...
<title>BeneficiariosProyectos</title>
<script src="../js/jquery.js"></script>
<script src="../js/Global.js"></script>
<script src="../js/BeneficiarioProyectos.js"></script>
...
?>
   ...
   <center><h1>Beneficiarios de Proyectos</h1></center>
    <section>
    <table border="0" align="center">
    	<tr>
        	<td width="400"><input type="text" class="form-control"placeholder="Buscar un beneficiario por: Nombre" id="bs-prod"/></td>
            <td width="20"></td>
            <td width="100"><button id="nuevo-producto" class="btn btn-primary btn-block">Nuevo</button></td>
            <td width="20"></td>
	    <td width="150"><button onclick="ExportarExcel();" class="btn btn-success btn-block">Exportar a Excel</button></td>
            <td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita Beneficiario de Proyectos</b></h4>
            </div>
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                    ...
                    <tr>
                	  ...
                	  <tr>
                      	<td>Nombre: </td>
                        <td><input type="text" required="required" class="form-control" name="nombreBeneficiario" id="nombreBeneficiario" maxlength="500"/></td>
                    </tr>
                    	  <td>Direccion: </td>
