...
<?php include ('../Menu/MenuNav.php'); ?>
    ...
    <table border="0" align="center">
    	<tr>
        	<td width="335">
          <input type="text" placeholder="Buscar Categoria por nombre" id="bs-prod" nombre="bs-prod"class="form-control"/>
          </td>
          <td width="100">&nbsp;
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <center>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita Categoria</b></h4>
              </center>
            </div>
            ...
            <div class="modal-body">
                  ...
                  <tr>
                	...
                	<tr>
                    	<td>Nombre: </td>
                      <td height="50"><input type="text" required="required" name="nombreCategoria" id="nombreCategoria" maxlength="400" class="form-control"/></td>
                  </tr>                 
                  </tr>
