...
<title>Navieras</title>
<script src="../js/jquery.js"></script>
<script src="../js/Global.js"></script>
<script src="../js/Navieras.js"></script>
...
<?php include ('../Menu/MenuNav.php'); ?>
    ...
    <table border="0" align="center">
    	<tr>
        	<td width="335">
          <input type="text" placeholder="Buscar Navieras por nombre" id="bs-prod" nombre="bs-prod"class="form-control"/>
          </td>
          <td width="100">&nbsp;
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <center>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita una Naviera</b></h4>
              </center>
            </div>
            ...
            <div class="modal-body">
                  ...
                  <tr>
                	...
                	<tr>
                    	<td>Nombre: </td>
                      <td height="50"><input type="text" required="required" name="nombreNaviera" id="nombreNaviera" maxlength="400" class="form-control"/></td>
                  </tr>                 
                  </tr>
