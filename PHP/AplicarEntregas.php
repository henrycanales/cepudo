<?php
  ...
  while($registro2 = mysqli_fetch_array($registro)){
    ...
    $tabla = $tabla.'<tr>
              ...
              <td>
              <a <button onclick="VerDetalle('.$registro2['EntregaId'].');"class="btn glyphicon glyphicon-th-list" alt="Ver Detalle" title="Ver Detalle"></button></a>
              <a <button onclick="aplicarEntregas('.$registro2['EntregaId'].');"class="btn glyphicon glyphicon-ok" alt="Aplicar Entrega" title="Aplicar Entrega"></button></a>
              <a <button onclick="Imprimir('.$registro2['EntregaId'].');"class="btn glyphicon glyphicon-print" alt="Imprimir" title="Imprimir"></button></a>
