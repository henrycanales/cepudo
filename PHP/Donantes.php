<?php
  ...
  $items = $_POST['items'];
    ...
    $nroProductos = mysqli_num_rows(mysqli_query(
            $conexion,"SELECT * FROM Donantes where Estado='Activo' and Nombre LIKE '%$dato%'"));
    }else{
...
$registro = mysqli_query(
            $conexion,"SELECT * FROM Donantes where Nombre LIKE '%$dato%' and Estado='Activo' Order By DonanteId Desc LIMIT $limit, $nroLotes ");
