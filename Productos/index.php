...
if($_SESSION['session_nivel_cepudo']=="Inventario" || $_SESSION['session_nivel_cepudo']=="Administrador" || $_SESSION['session_nivel_cepudo']=="root")
{
...
<?php include ('../Menu/MenuNav.php'); ?>
    ...
    <table border="0" align="center">
    	<tr>
        	<td width="335">
          <input type="text" placeholder="Buscar Producto por nombre" id="bs-prod" nombre="bs-prod"class="form-control"/>
          </td>
          <td width="100">&nbsp;
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <center>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita Producto</b></h4>
              </center>
            </div>
            ...
            <div class="modal-body">
                  ...
                  <tr>
                	...
                	<tr>
                    	<td>Descripcion: </td>
                      <td height="50"><input type="text" required="required" name="nombreProducto" id="nombreProducto" maxlength="400" class="form-control"/></td>
                  </tr>                 
                  </tr>
