...
$registro = mysqli_query($conexion,"SELECT * FROM AjusteInventario where AjusteId= '$Id' ");
$registro2 = mysqli_fetch_array($registro);

$TipoAjuste = $registro2['TipoAjuste'];
$Comentarios = $registro2['Comentarios'];
...
$pdf->Ln(10);
$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell(190, 5,'AJUSTE DE INVENTARIO # '.$Id,0,0,'C');
$pdf->Ln(5);
$pdf->SetFont('Arial', 'B', 9);
$pdf->Cell(30, 5,'Tipo de Ajuste:',0);
$pdf->SetFont('Arial', '', 9);
$pdf->MultiCell(150, 5,$TipoAjuste,0);
$pdf->SetFont('Arial', 'B', 9);
...
$pdf->Cell(38, 5,'Comentarios:',0);
$pdf->SetFont('Arial', '', 9);
$pdf->MultiCell(150, 5,$Comentarios,0);
