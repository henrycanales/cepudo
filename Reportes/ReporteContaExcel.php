...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr >
    ...
    <td bgcolor="#E6E6E6" width="200" align="center"><strong><center><FONT FACE="Arial" SIZE=3 COLOR="Grey">LLEGO A BODEGA</FONT></center></strong></td>
...
$registro = mysqli_query($conexion,"SELECT * FROM contabilidad where Embarque LIKE '%$dato%' and YEAR(FechaRegistro) = '$Ano'
...
if($dato == 'Todo' && $Fecha !='Todo'){
$registro = mysqli_query($conexion,"SELECT * FROM contabilidad where YEAR(FechaRegistro) = '$Ano'
AND MONTH(FechaRegistro) = '$Mes' Order By DeclaracionId Desc"); 
}

if($dato == 'Todo' && $Fecha =='Todo'){
$registro = mysqli_query($conexion,"SELECT * FROM contabilidad Order By DeclaracionId Desc"); 
}

if($dato != 'Todo' && $Fecha =='Todo'){
$registro = mysqli_query($conexion,"SELECT * FROM contabilidad where Embarque LIKE '%$dato%' or NumeroDispensa LIKE '%$dato%' 
...
?>  
 ...
 <td align="center"><FONT FACE="Arial" SIZE=3 COLOR="Grey">L <?php echo round($registro2['LpsTotal'],2);?></FONT></td>
 <td align="center"><FONT FACE="Arial" SIZE=3 COLOR="Grey">% <?php echo round($registro2['PorcentajeDistribuido'],2);?></FONT></td>
 <td align="center"><FONT FACE="Arial" SIZE=3 COLOR="Grey">L <?php echo round($registro2['LpsValorDistribuido'],2);?></FONT></td>
 <td align="center"><FONT FACE="Arial" SIZE=3 COLOR="Grey">L <?php echo round(($registro2['LpsTotal'] - $registro2['LpsValorDistribuido']),2);?></FONT></td>
