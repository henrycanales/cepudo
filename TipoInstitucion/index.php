...
<script src="../js/Tinstituciones.js"></script>
<script type="text/javascript" src="../js/validation.min.js"></script>

<?php include ('../Menu/MenuNav.php'); ?>
</head>
    <center>
    <h1>TIPOS DE INSTITUCIONES</h1>
    <section>
    
    <table border="0" align="center">
    	<tr>
        	<td width="335">
          <input type="text" placeholder="Buscar tipo de institucion por Descripcion" id="bs-prod" nombre="bs-prod"class="form-control"/>
          </td>
          <td width="100">&nbsp;
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <center>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita Tipo Institucion</b></h4>
              </center>
            </div>
            ...
            <div class="modal-body">
                  ...
                  <tr>
                	...
                	<tr>
                    	<td>Descripcion: </td>
                      <td height="50"><input type="text" required="required" name="nombreTipo" id="nombreTipo" maxlength="400" class="form-control"/></td>
                  </tr>                 
                  </tr>
