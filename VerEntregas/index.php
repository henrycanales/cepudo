...
if($_SESSION['session_nivel_cepudo']=="Entregas" ||$_SESSION['session_nivel_cepudo']=="AplicarEntrega" || $_SESSION['session_nivel_cepudo']=="root")
{
...
<script src="../js/VerEntregas.js"></script>
