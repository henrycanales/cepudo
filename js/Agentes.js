$('document').ready(function(){ 
	 ...
	 $("#formulario").validate({
      rules:
	  {
	   ...
	   {
            nombreAgente:{
                      required: "Ingrese Nombre de Agente Aduanero.!"
                     },
...
function eliminarRegistro(id){
	var pag=1;
	var url = '../PHP/EliminarAgente.php';
	var items = document.getElementById("Items").value;
