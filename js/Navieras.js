$('document').ready(function(){ 
	 ...
	 $("#formulario").validate({
      rules:
	  {
	   ...
	   {
            nombreNaviera:{
                      required: "Ingrese Nombre de Naviera.!"
                     },
...
function agregaRegistro(){
	...
	var pag=1;
	var url = '../PHP/AgregarNaviera.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminarRegistro(id){
	var pag=1;
	var url = '../PHP/EliminarNaviera.php';
	var items = document.getElementById("Items").value;
