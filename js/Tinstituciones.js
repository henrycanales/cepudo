$('document').ready(function(){ 
	 ...
	 $("#formulario").validate({
      rules:
	  {
	   ...
	   {
            nombreTipo:{
                      required: "Ingrese Tipo Institucion.!"
                     },
	...
	$('#bs-prod').on('keyup',function(){
		...
		var url = '../PHP/TiposInstituciones.php';
...
function agregaRegistro(){
	...
	var pag=1;
	var url = '../PHP/AgregarTipoInstitucion.php';
	$.ajax({
		type:'POST',
		url:url,
...
function editarRegistro(id){
	...
	var url = '../PHP/EditarTipoInstitucion.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function eliminarRegistro(id){
	var pag=1;
	var url = '../PHP/EliminarTipoInstitucion.php';
	var items = document.getElementById("Items").value;
